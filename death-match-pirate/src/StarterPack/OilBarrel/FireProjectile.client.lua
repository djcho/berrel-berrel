...
local function fireProjectile()
	...
	if MyHumanoid and MyHumanoid.Health > 0 then
		...
		-- 서버로 이벤트 전송
		throwingBarrelEvent:FireServer(Tool.Name, targetPosition)
...
throwingBarrelEvent.OnClientEvent:Connect(function(barrelPart, x0, v0, g, t)
	local barrelClone = barrelPart:Clone()
	...
	connection = RunService.RenderStepped:Connect(function()
		...
		barrelClone.CFrame = CFrame.new(0.5 * g * nt * nt + v0 * nt + x0) * CFrame.Angles(rotationAngleX, rotationAngleY, rotationAngleZ)
